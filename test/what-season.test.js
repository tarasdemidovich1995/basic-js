...
describe('What season', () => {
    ...
    describe('base requirements', () => {
        ...
        it.optional('some pack of tests', () => {
            ...
            assert.equal(getSeason(new Date(83, 9, 25, 16, 20, 23, 544)), 'autumn');
            assert.equal(getSeason(new Date(81, 10, 13, 12, 50, 13, 493)), 'autumn');
            assert.equal(getSeason(new Date(481, 1, 5, 21, 58, 37, 272)), 'winter');
            assert.equal(getSeason(new Date(369, 9, 26, 4, 38, 0, 377)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1674, 9, 4, 10, 22, 44, 545)), 'autumn');
            ...
            assert.equal(getSeason(new Date(920, 9, 29, 17, 14, 55, 653)), 'autumn');
            assert.equal(getSeason(new Date(2361, 2, 24, 22, 13, 47, 69)), 'spring');
            assert.equal(getSeason(new Date(1981, 3, 1, 13, 25, 56, 329)), 'spring');
            assert.equal(getSeason(new Date(371, 9, 2, 22, 45, 13, 528)), 'autumn');
            assert.equal(getSeason(new Date(1213, 5, 31, 14, 57, 42, 699)), 'summer');
            assert.equal(getSeason(new Date(1418, 8, 31, 15, 59, 4, 996)), 'autumn');
            assert.equal(getSeason(new Date(1634, 8, 0, 8, 27, 2, 81)), 'summer');
            assert.equal(getSeason(new Date(2029, 8, 14, 16, 46, 14, 40)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1072, 8, 29, 18, 59, 55, 281)), 'autumn');
            assert.equal(getSeason(new Date(842, 4, 24, 14, 5, 45, 70)), 'spring');
            assert.equal(getSeason(new Date(1193, 10, 3, 17, 36, 2, 558)), 'autumn');
            assert.equal(getSeason(new Date(1391, 9, 5, 0, 37, 45, 934)), 'autumn');
            ...
            assert.equal(getSeason(new Date(181, 9, 17, 8, 31, 33, 800)), 'autumn');
            assert.equal(getSeason(new Date(752, 10, 10, 22, 51, 3, 797)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1631, 8, 27, 6, 37, 23, 782)), 'autumn');
            assert.equal(getSeason(new Date(430, 0, 4, 18, 4, 34, 863)), 'winter');
            assert.equal(getSeason(new Date(1022, 10, 16, 10, 41, 51, 476)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1885, 8, 13, 9, 36, 15, 807)), 'autumn');
            assert.equal(getSeason(new Date(1126, 3, 6, 5, 9, 1, 724)), 'spring');
            assert.equal(getSeason(new Date(866, 8, 19, 6, 38, 15, 964)), 'autumn');
            ...
            assert.equal(getSeason(new Date(2211, 8, 26, 21, 6, 7, 52)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1092, 8, 18, 12, 23, 36, 32)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1436, 10, 12, 1, 41, 37, 971)), 'autumn');
            assert.equal(getSeason(new Date(1815, 2, 13, 11, 30, 52, 865)), 'spring');
            assert.equal(getSeason(new Date(750, 9, 19, 14, 4, 21, 934)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1036, 9, 23, 13, 57, 31, 880)), 'autumn');
            assert.equal(getSeason(new Date(1596, 8, 27, 15, 53, 55, 594)), 'autumn');
            assert.equal(getSeason(new Date(1415, 9, 25, 19, 34, 45, 741)), 'autumn');
            assert.equal(getSeason(new Date(235, 0, 0, 17, 9, 0, 802)), 'winter');
            assert.equal(getSeason(new Date(260, 8, 22, 14, 39, 46, 366)), 'autumn');
            assert.equal(getSeason(new Date(1003, 9, 28, 20, 42, 14, 910)), 'autumn');
            ...
            assert.equal(getSeason(new Date(1667, 9, 19, 22, 46, 48, 373)), 'autumn');
