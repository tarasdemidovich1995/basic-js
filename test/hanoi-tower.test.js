...
describe('Hanoi tower', () => {
    ...
    describe('base requirements', () => {
        it.optional('returns correct answer', () => {
            ...
            assert.deepEqual(calculateHanoi(736, 78853564), { turns: 3.6147378671465184e+221, seconds: 1.6502813140731935e+217 });
            assert.deepEqual(calculateHanoi(243, 58252885), { turns: 1.4134776518227075e+73, seconds: 8.735223236689044e+68 });
            ...
            assert.deepEqual(calculateHanoi(349, 73223765), { turns: 1.1467493079950358e+105, seconds: 5.6379202964804236e+100 });
            ...
            assert.deepEqual(calculateHanoi(427, 67748239), { turns: 3.4658371176510186e+128, seconds: 1.8416734970105521e+124 });
            assert.deepEqual(calculateHanoi(878, 38337969), { turns: 2.0152837033678636e+264, seconds: 1.892385413563329e+260 });
            assert.deepEqual(calculateHanoi(872, 56576738), { turns: 3.148880786512287e+262, seconds: 2.0036451785969407e+258 });
            assert.deepEqual(calculateHanoi(868, 38673496), { turns: 1.9680504915701793e+261, seconds: 1.831999302481639e+257 });
            assert.deepEqual(calculateHanoi(744, 96646943), { turns: 9.253728939895087e+223, seconds: 3.446919597200536e+219 });
            ...
            assert.deepEqual(calculateHanoi(344, 29772812), { turns: 3.583591587484487e+103, seconds: 4.333124366937242e+99 });
            assert.deepEqual(calculateHanoi(661, 38283196), { turns: 9.568131466127622e+198, seconds: 8.997491556885543e+194 });
            ...
            assert.deepEqual(calculateHanoi(388, 35826136), { turns: 6.304320991423117e+116, seconds: 6.334915819312253e+112 });
            ...
            assert.deepEqual(calculateHanoi(845, 42193444), { turns: 2.346099009001469e+254, seconds: 2.0017224553665938e+250 });
            assert.deepEqual(calculateHanoi(431, 25476858), { turns: 5.54533938824163e+129, seconds: 7.835825672722228e+125 });
            assert.deepEqual(calculateHanoi(541, 42323348), { turns: 7.198262071269114e+162, seconds: 6.122800931667507e+158 });
            ...
            assert.deepEqual(calculateHanoi(948, 37721566), { turns: 2.379227053564453e+285, seconds: 2.270642049386823e+281 });
            assert.deepEqual(calculateHanoi(133, 92944378), { turns: 1.0889035741470031e+40, seconds: 4.217633117012426e+35 });
            assert.deepEqual(calculateHanoi(535, 61891748), { turns: 1.1247284486357991e+161, seconds: 6.5421038279430674e+156 });
            assert.deepEqual(calculateHanoi(575, 56173717), { turns: 1.2366520073655227e+173, seconds: 7.925320709177714e+168 });
            assert.deepEqual(calculateHanoi(384, 29564582), { turns: 3.940200619639448e+115, seconds: 4.7978768076957804e+111 });
            assert.deepEqual(calculateHanoi(418, 57132412), { turns: 6.769213120412146e+125, seconds: 4.2653839353892015e+121 });
            assert.deepEqual(calculateHanoi(997, 23587654), { turns: 1.3393857589828342e+300, seconds: 2.0442002126782946e+296 });
            assert.deepEqual(calculateHanoi(788, 64589644), { turns: 1.6279332111523082e+237, seconds: 9.073528196173847e+232 });
            assert.deepEqual(calculateHanoi(181, 17548965), { turns: 3.064991081731778e+54, seconds: 6.287531996464977e+50 });
            ...
            assert.deepEqual(calculateHanoi(283, 56191489), { turns: 1.5541351137805833e+85, seconds: 9.956821769948293e+80 });
            assert.deepEqual(calculateHanoi(751, 29253759), { turns: 1.1844773043065711e+226, seconds: 1.4576308964272442e+222 });
            assert.deepEqual(calculateHanoi(887, 92287796), { turns: 1.0318252561243462e+267, seconds: 4.0249860577964676e+262 });
            assert.deepEqual(calculateHanoi(335, 55886994), { turns: 6.999202319305638e+100, seconds: 4.508585369522701e+96 });
            assert.deepEqual(calculateHanoi(355, 81496472), { turns: 7.339195571168229e+106, seconds: 3.2419935989628636e+102 });
            assert.deepEqual(calculateHanoi(784, 57858431), { turns: 1.0174582569701926e+236, seconds: 6.33071042851593e+231 });
            assert.deepEqual(calculateHanoi(579, 38459234), { turns: 1.9786432117848363e+174, seconds: 1.852121017913516e+170 });
            assert.deepEqual(calculateHanoi(167, 92464512), { turns: 1.8707220957835557e+50, seconds: 7.283442478797487e+45 });
            assert.deepEqual(calculateHanoi(659, 14137537), { turns: 2.3920328665319055e+198, seconds: 6.091102233376902e+194 });
            ...
            assert.deepEqual(calculateHanoi(597, 74123793), { turns: 5.186894461101241e+179, seconds: 2.5191398475742423e+175 });
            assert.deepEqual(calculateHanoi(224, 47242246), { turns: 2.695994666715064e+67, seconds: 2.0544283182840694e+63 });
            assert.deepEqual(calculateHanoi(414, 19497265), { turns: 4.230758200257591e+124, seconds: 7.811726168222737e+120 });
            assert.deepEqual(calculateHanoi(213, 26711114), { turns: 1.3164036458569648e+64, seconds: 1.774187750119697e+60 });
            assert.deepEqual(calculateHanoi(746, 66492287), { turns: 3.701491575958035e+224, seconds: 2.0040474278541397e+220 });
            ...
            assert.deepEqual(calculateHanoi(149, 89129554), { turns: 7.1362384635298e+44, seconds: 2.882372604344826e+40 });
            ...
            assert.deepEqual(calculateHanoi(143, 32791754), { turns: 1.1150372599265312e+43, seconds: 1.2241291318956321e+39 });
            assert.deepEqual(calculateHanoi(971, 51433778), { turns: 1.99584030953472e+292, seconds: 1.3969467913333123e+288 });
            assert.deepEqual(calculateHanoi(842, 66496392), { turns: 2.932623761251836e+253, seconds: 1.5876719357204538e+249 });
            ...
            assert.deepEqual(calculateHanoi(416, 78115538), { turns: 1.6923032801030364e+125, seconds: 7.799078089138849e+120 });
            assert.deepEqual(calculateHanoi(115, 39194336), { turns: 4.153837486827862e+34, seconds: 3.8152999843090347e+30 });
